...
public class HollowModel extends EntityModel<Hollow> {
	...
	@Override
	public void setupAnim(Hollow entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		bb_main.yRot = netHeadYaw * ((float)Math.PI / 180F);
	}
